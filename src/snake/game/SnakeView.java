...
public class SnakeView extends TileView {
	  ...
	  public SnakeView(Context context, AttributeSet attrs) {
		  ...
		  private void initSnakeView() {
		    ...
		    resetTiles(4);
		    loadTile(RED_STAR, r.getDrawable(R.drawable.ic_launcher));
		    loadTile(YELLOW_STAR, r.getDrawable(R.drawable.ic_action_search));
		    loadTile(GREEN_STAR, r.getDrawable(R.drawable.ic_launcher));
